...
export const mockLeads: Lead[] = [
  {
    id: 'lead-001', empresa_id: 'emp-001', name: 'Carlos Silva', phone: '+5511999001122',
    temperature: 'hot', score: 88, funnel_stage: 'negotiation', assigned_agent: 'kairos',
  ...
  {
    id: 'lead-002', empresa_id: 'emp-001', name: 'Ana Beatriz', phone: '+5511988112233',
    temperature: 'warm', score: 55, funnel_stage: 'qualified', assigned_agent: 'ares',
  ...
  {
    id: 'lead-003', empresa_id: 'emp-001', name: 'Roberto Mendes', phone: '+5511977223344',
    temperature: 'cold', score: 20, funnel_stage: 'captured', assigned_agent: 'ares',
  ...
  {
    id: 'lead-004', empresa_id: 'emp-001', name: 'Fernanda Costa', phone: '+5511966334455',
    temperature: 'hot', score: 92, funnel_stage: 'converted', assigned_agent: 'kairos',
    sentiment: 'positive', product_interest: 'Plano Premium Anual',
    objections: ['preço'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-001', content: 'video-depoimento' },
    created_at: '2026-03-20T08:00:00Z', updated_at: '2026-03-25T16:30:00Z',
  },
  {
    id: 'lead-005', empresa_id: 'emp-001', name: 'Marcos Oliveira', phone: '+5511955445566',
    temperature: 'warm', score: 60, funnel_stage: 'qualified', assigned_agent: 'kairos',
  ...
  {
    id: 'lead-006', empresa_id: 'emp-001', name: 'Juliana Santos', phone: '+5511944556677',
    temperature: 'hot', score: 85, funnel_stage: 'negotiation', assigned_agent: 'kairos',
    sentiment: 'positive', product_interest: 'Plano Premium Anual',
  ...
  {
    id: 'lead-007', empresa_id: 'emp-001', name: 'Pedro Almeida', phone: '+5511933667788',
    temperature: 'cold', score: 15, funnel_stage: 'captured', assigned_agent: 'ares',
    sentiment: 'neutral', product_interest: 'Plano Básico Mensal',
  ...
  {
    id: 'lead-008', empresa_id: 'emp-001', name: 'Lucia Ferreira', phone: '+5511922778899',
    temperature: 'warm', score: 45, funnel_stage: 'qualified', assigned_agent: 'ares',
  ...
  {
    id: 'lead-009', empresa_id: 'emp-001', name: 'Ricardo Tavares', phone: '+5511911889900',
    temperature: 'hot', score: 78, funnel_stage: 'converted', assigned_agent: 'kairos',
  ...
  {
    id: 'lead-010', empresa_id: 'emp-001', name: 'Camila Rocha', phone: '+5511900990011',
...
export const mockCampaigns: Campaign[] = [
  {
    id: 'camp-001', empresa_id: 'emp-001', name: 'Video Depoimentos - Premium', status: 'ativa',
    total_spent: 2450.80, cpl: 12.25, roas: 4.2, leads_generated: 200, confirmed_sales: 18,
    created_at: '2026-03-01T00:00:00Z',
  },
  {
    id: 'camp-002', empresa_id: 'emp-001', name: 'Carrossel Benefícios - Multi', status: 'ativa',
    total_spent: 1830.50, cpl: 18.30, roas: 2.8, leads_generated: 100, confirmed_sales: 8,
    created_at: '2026-03-05T00:00:00Z',
  },
  {
    id: 'camp-003', empresa_id: 'emp-001', name: 'Imagem Promo - Básico', status: 'pausada',
...
export const mockPayments: PaymentLog[] = [
  { id: 'pay-001', empresa_id: 'emp-001', lead_id: 'lead-004', amount: 2970, status: 'confirmed', campaign_id: 'camp-001', created_at: '2026-03-25T16:30:00Z' },
  { id: 'pay-002', empresa_id: 'emp-001', lead_id: 'lead-009', amount: 497, status: 'confirmed', campaign_id: 'camp-002', created_at: '2026-03-22T14:00:00Z' },
  { id: 'pay-003', empresa_id: 'emp-001', lead_id: 'lead-001', amount: 2970, status: 'pending', campaign_id: 'camp-001', created_at: '2026-03-31T10:00:00Z' },
]

export const mockConversations: Conversation[] = [
  { id: 'conv-001', empresa_id: 'emp-001', lead_id: 'lead-001', messages_count: 24, duration_minutes: 35, agent: 'kairos', created_at: '2026-03-31T10:00:00Z' },
  { id: 'conv-002', empresa_id: 'emp-001', lead_id: 'lead-002', messages_count: 8, duration_minutes: 12, agent: 'ares', created_at: '2026-03-30T18:00:00Z' },
  { id: 'conv-003', empresa_id: 'emp-001', lead_id: 'lead-004', messages_count: 32, duration_minutes: 55, agent: 'kairos', created_at: '2026-03-25T16:00:00Z' },
  { id: 'conv-004', empresa_id: 'emp-001', lead_id: 'lead-005', messages_count: 15, duration_minutes: 20, agent: 'kairos', created_at: '2026-03-31T08:00:00Z' },
  { id: 'conv-005', empresa_id: 'emp-001', lead_id: 'lead-006', messages_count: 28, duration_minutes: 45, agent: 'kairos', created_at: '2026-03-31T11:00:00Z' },
]

export const mockMessages: Message[] = [
  // conv-001: Kairos falando com Carlos Silva
  ...
  // conv-002: Ares nutrição Ana Beatriz
  ...
  // conv-003: Kairos vendendo Fernanda Costa
  ...
  // conv-004: Kairos falando com Marcos Oliveira
  ...
  // conv-005: Kairos falando com Juliana Santos
...
export const mockAlerts: Alert[] = [
  { id: 'alt-001', empresa_id: 'emp-001', tipo: 'venda', description: 'Venda confirmada: Fernanda Costa — Plano Premium Anual (R$ 2.970)', created_at: '2026-03-31T10:30:00Z' },
  { id: 'alt-002', empresa_id: 'emp-001', tipo: 'baleia', description: 'Lead de alto valor detectado: Carlos Silva (score 88)', created_at: '2026-03-31T10:15:00Z' },
  { id: 'alt-003', empresa_id: 'emp-001', tipo: 'campanha_pausada', description: 'Campanha "Imagem Promo - Básico" pausada por CPA acima do limite', created_at: '2026-03-31T09:00:00Z' },
  { id: 'alt-004', empresa_id: 'emp-001', tipo: 'campanha_escalada', description: 'Campanha "Video Depoimentos" escalada +15% — ROAS acima da meta', created_at: '2026-03-31T08:30:00Z' },
  { id: 'alt-005', empresa_id: 'emp-001', tipo: 'humano_solicitado', description: 'Marcos Oliveira pediu para falar com um humano — sentimento negativo', created_at: '2026-03-31T08:00:00Z' },
  { id: 'alt-006', empresa_id: 'emp-001', tipo: 'anomalia', description: 'Padrão suspeito detectado: 12 mensagens em 30s do número +5511900000000', created_at: '2026-03-30T23:00:00Z' },
  { id: 'alt-007', empresa_id: 'emp-001', tipo: 'venda', description: 'Venda confirmada: Ricardo Tavares — Plano Básico Mensal (R$ 497)', created_at: '2026-03-30T14:00:00Z' },
]

export const mockSupportTickets: SupportTicket[] = [
  { id: 'ticket-001', empresa_id: 'emp-001', subject: 'Como configurar o tom de voz do agente?', status: 'resolved', created_at: '2026-03-25T09:00:00Z', updated_at: '2026-03-25T09:12:00Z' },
  { id: 'ticket-002', empresa_id: 'emp-001', subject: 'Campanha pausada automaticamente', status: 'resolved', created_at: '2026-03-28T14:30:00Z', updated_at: '2026-03-28T14:45:00Z' },
  { id: 'ticket-003', empresa_id: 'emp-001', subject: 'Erro ao gerar relatório PDF', status: 'open', created_at: '2026-03-31T08:00:00Z', updated_at: '2026-03-31T08:10:00Z' },
]

export const mockSupportMessages: SupportMessage[] = [
  // ticket-001
  { id: 'smsg-001', ticket_id: 'ticket-001', sender: 'user', text: 'Oi, como faço para mudar o tom de voz do agente Kairos? Quero que ele seja mais informal.', created_at: '2026-03-25T09:00:00Z' },
  { id: 'smsg-002', ticket_id: 'ticket-001', sender: 'agent', text: 'Olá! Para configurar o tom de voz do Kairos, acesse Configurações > Tom de Voz. Lá você pode personalizar o estilo de comunicação de cada agente individualmente.', created_at: '2026-03-25T09:01:00Z' },
