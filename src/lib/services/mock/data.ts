import type { Lead, Campaign, PaymentLog, Conversation, Alert, Company, Message, SupportTicket, SupportMessage } from '@/lib/types'

export const MOCK_COMPANY_ID = 'emp-001'

export const mockCompanies: Company[] = [
  {
    id: 'emp-001',
    name: 'TechFit Academia Digital',
    target_roas: 3.0,
    target_cpl: 15.0,
    daily_budget: 500,
    card_limit: 15000,
    tone_of_voice: 'Direto e motivacional, sem enrolação. Foco em resultados concretos.',
    whatsapp_alerts: '+5511999887766',
    health_score: 78,
    subscription_status: 'active',
  },
  {
    id: 'emp-002',
    name: 'Dra. Marina Odontologia',
    target_roas: 4.0,
    target_cpl: 25.0,
    daily_budget: 300,
    card_limit: 10000,
    tone_of_voice: 'Profissional e acolhedor. Transmitir confiança e expertise.',
    whatsapp_alerts: '+5511988776655',
    health_score: 45,
    subscription_status: 'active',
  },
  {
    ...
    daily_budget: 800,
    card_limit: 25000,
    tone_of_voice: 'Técnico mas acessível. Foco em economia e sustentabilidade.',
    whatsapp_alerts: '+5511977665544',
    health_score: 92,
    subscription_status: 'active',
  },
]
...
export const mockLeads: Lead[] = [
  {
    id: 'lead-001', company_id: 'emp-001', name: 'Carlos Silva', phone: '+5511999001122',
    temperature: 'hot', score: 88, funnel_stage: 'negotiation', assigned_agent: 'ares',
    sentiment: 'positive', product_interest: 'Plano Premium Anual',
    objections: ['preço'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-001', content: 'video-depoimento' },
    created_at: '2026-03-28T14:30:00Z', updated_at: '2026-03-31T10:15:00Z',
  },
  {
    id: 'lead-002', company_id: 'emp-001', name: 'Ana Beatriz', phone: '+5511988112233',
    temperature: 'warm', score: 55, funnel_stage: 'qualified', assigned_agent: 'hermes',
    sentiment: 'neutral', product_interest: 'Plano Básico Mensal',
    objections: ['prazo', 'desconfiança'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-002', content: 'carrossel-beneficios' },
    created_at: '2026-03-29T09:00:00Z', updated_at: '2026-03-30T18:00:00Z',
  },
  {
    id: 'lead-003', company_id: 'emp-001', name: 'Roberto Mendes', phone: '+5511977223344',
    temperature: 'cold', score: 20, funnel_stage: 'captured', assigned_agent: 'hermes',
    sentiment: 'neutral', product_interest: 'Plano Premium Anual',
    objections: [], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-001', content: 'video-depoimento' },
    created_at: '2026-03-30T22:00:00Z', updated_at: '2026-03-30T22:00:00Z',
  },
  {
    id: 'lead-004', company_id: 'emp-001', name: 'Fernanda Costa', phone: '+5511966334455',
    temperature: 'hot', score: 92, funnel_stage: 'converted', assigned_agent: 'ares',
    sentiment: 'positive', product_interest: 'Plano Premium Anual',
    objections: ['preço'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-001', content: 'video-depoimento' },
    created_at: '2026-03-20T08:00:00Z', updated_at: '2026-03-25T16:30:00Z',
  },
  {
    id: 'lead-005', company_id: 'emp-001', name: 'Marcos Oliveira', phone: '+5511955445566',
    temperature: 'warm', score: 60, funnel_stage: 'qualified', assigned_agent: 'ares',
    sentiment: 'negative', product_interest: 'Plano Básico Mensal',
    objections: ['não entendeu o produto', 'concorrente'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-003', content: 'imagem-promo' },
    created_at: '2026-03-27T11:00:00Z', updated_at: '2026-03-31T08:00:00Z',
  },
  {
    id: 'lead-006', company_id: 'emp-001', name: 'Juliana Santos', phone: '+5511944556677',
    temperature: 'hot', score: 85, funnel_stage: 'negotiation', assigned_agent: 'ares',
    sentiment: 'positive', product_interest: 'Plano Premium Anual',
    objections: ['prazo'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-002', content: 'carrossel-beneficios' },
    created_at: '2026-03-26T15:00:00Z', updated_at: '2026-03-31T11:00:00Z',
  },
  {
    id: 'lead-007', company_id: 'emp-001', name: 'Pedro Almeida', phone: '+5511933667788',
    temperature: 'cold', score: 15, funnel_stage: 'captured', assigned_agent: 'hermes',
    sentiment: 'neutral', product_interest: 'Plano Básico Mensal',
    objections: [], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-003', content: 'imagem-promo' },
    created_at: '2026-03-31T06:00:00Z', updated_at: '2026-03-31T06:00:00Z',
  },
  {
    id: 'lead-008', company_id: 'emp-001', name: 'Lucia Ferreira', phone: '+5511922778899',
    temperature: 'warm', score: 45, funnel_stage: 'qualified', assigned_agent: 'hermes',
    sentiment: 'positive', product_interest: 'Consultoria Individual',
    objections: ['preço', 'desconfiança'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-001', content: 'video-depoimento' },
    created_at: '2026-03-25T13:00:00Z', updated_at: '2026-03-30T20:00:00Z',
  },
  {
    id: 'lead-009', company_id: 'emp-001', name: 'Ricardo Tavares', phone: '+5511911889900',
    temperature: 'hot', score: 78, funnel_stage: 'converted', assigned_agent: 'ares',
    sentiment: 'positive', product_interest: 'Plano Básico Mensal',
    objections: [], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-002', content: 'carrossel-beneficios' },
    created_at: '2026-03-18T10:00:00Z', updated_at: '2026-03-22T14:00:00Z',
  },
  {
    id: 'lead-010', company_id: 'emp-001', name: 'Camila Rocha', phone: '+5511900990011',
    temperature: 'cold', score: 30, funnel_stage: 'lost', assigned_agent: null,
    sentiment: 'negative', product_interest: 'Plano Premium Anual',
    objections: ['preço', 'concorrente'], utm_source: { source: 'meta', medium: 'cpc', campaign: 'camp-003', content: 'imagem-promo' },
...
export const mockCampaigns: Campaign[] = [
  {
    id: 'camp-001', company_id: 'emp-001', name: 'Video Depoimentos - Premium', status: 'active',
    total_spent: 2450.80, cpl: 12.25, roas: 4.2, leads_generated: 200, confirmed_sales: 18,
    created_at: '2026-03-01T00:00:00Z',
  },
  {
    id: 'camp-002', company_id: 'emp-001', name: 'Carrossel Benefícios - Multi', status: 'active',
    total_spent: 1830.50, cpl: 18.30, roas: 2.8, leads_generated: 100, confirmed_sales: 8,
    created_at: '2026-03-05T00:00:00Z',
  },
  {
    id: 'camp-003', company_id: 'emp-001', name: 'Imagem Promo - Básico', status: 'paused',
    total_spent: 920.00, cpl: 30.66, roas: 1.1, leads_generated: 30, confirmed_sales: 2,
    created_at: '2026-03-10T00:00:00Z',
  },
]

export const mockPayments: PaymentLog[] = [
  { id: 'pay-001', company_id: 'emp-001', lead_id: 'lead-004', amount: 2970, status: 'confirmed', campaign_id: 'camp-001', created_at: '2026-03-25T16:30:00Z' },
  { id: 'pay-002', company_id: 'emp-001', lead_id: 'lead-009', amount: 497, status: 'confirmed', campaign_id: 'camp-002', created_at: '2026-03-22T14:00:00Z' },
  { id: 'pay-003', company_id: 'emp-001', lead_id: 'lead-001', amount: 2970, status: 'pending', campaign_id: 'camp-001', created_at: '2026-03-31T10:00:00Z' },
]

export const mockConversations: Conversation[] = [
  { id: 'conv-001', company_id: 'emp-001', lead_id: 'lead-001', lead_name: 'Carlos Silva', lead_phone: '5511999887766', messages_count: 24, duration_minutes: 35, agent: 'ares', is_human_takeover: false, is_whale: false, funnel_stage: 'negotiating', temperature: 'warm', last_message_preview: 'Pode liberar, vou testar.', last_message_at: '2026-03-31T10:10:00Z', created_at: '2026-03-31T10:00:00Z' },
  { id: 'conv-002', company_id: 'emp-001', lead_id: 'lead-002', lead_name: 'Ana Beatriz', lead_phone: '5511988776655', messages_count: 8, duration_minutes: 12, agent: 'hermes', is_human_takeover: false, is_whale: false, funnel_stage: 'qualifying', temperature: 'cold', last_message_preview: 'Quanto tempo leva pra ver resultado?', last_message_at: '2026-03-30T18:05:00Z', created_at: '2026-03-30T18:00:00Z' },
  { id: 'conv-003', company_id: 'emp-001', lead_id: 'lead-004', lead_name: 'Fernanda Costa', lead_phone: '5511977665544', messages_count: 32, duration_minutes: 55, agent: 'ares', is_human_takeover: false, is_whale: true, funnel_stage: 'closing', temperature: 'hot', last_message_preview: 'Fechado! Manda o link de pagamento.', last_message_at: '2026-03-25T16:30:00Z', created_at: '2026-03-25T16:00:00Z' },
  { id: 'conv-004', company_id: 'emp-001', lead_id: 'lead-005', lead_name: 'Pedro Henrique', lead_phone: '5511966554433', messages_count: 15, duration_minutes: 20, agent: 'ares', is_human_takeover: true, is_whale: false, funnel_stage: 'consulting', temperature: 'warm', last_message_preview: 'Preciso falar com alguem da equipe.', last_message_at: '2026-03-31T08:20:00Z', created_at: '2026-03-31T08:00:00Z' },
  { id: 'conv-005', company_id: 'emp-001', lead_id: 'lead-006', lead_name: 'Julia Santos', lead_phone: '5511955443322', messages_count: 28, duration_minutes: 45, agent: 'ares', is_human_takeover: false, is_whale: false, funnel_stage: 'negotiating', temperature: 'hot', last_message_preview: 'Vou pensar e volto amanha.', last_message_at: '2026-03-31T11:45:00Z', created_at: '2026-03-31T11:00:00Z' },
]
...
export const mockRoiTotal = {
  invested: 5201.30,
  revenue: 18467.00,
  history_7d: [2.8, 3.1, 2.9, 3.4, 3.2, 3.5, 3.55],
}

export const mockAlerts: Alert[] = [
  { id: 'alt-001', company_id: 'emp-001', type: 'sale', description: 'Venda confirmada: Fernanda Costa — Plano Premium Anual (R$ 2.970)', created_at: '2026-03-31T10:30:00Z' },
  { id: 'alt-002', company_id: 'emp-001', type: 'whale', description: 'Lead de alto valor detectado: Carlos Silva (score 88)', created_at: '2026-03-31T10:15:00Z' },
  { id: 'alt-003', company_id: 'emp-001', type: 'campaign_paused', description: 'Campanha "Imagem Promo - Básico" pausada por CPA acima do limite', created_at: '2026-03-31T09:00:00Z' },
  { id: 'alt-004', company_id: 'emp-001', type: 'campaign_scaled', description: 'Campanha "Video Depoimentos" escalada +15% — ROAS acima da meta', created_at: '2026-03-31T08:30:00Z' },
  { id: 'alt-005', company_id: 'emp-001', type: 'human_requested', description: 'Marcos Oliveira pediu para falar com um humano — sentimento negativo', created_at: '2026-03-31T08:00:00Z' },
  { id: 'alt-006', company_id: 'emp-001', type: 'anomaly', description: 'Padrão suspeito detectado: 12 mensagens em 30s do número +5511900000000', created_at: '2026-03-30T23:00:00Z' },
  { id: 'alt-007', company_id: 'emp-001', type: 'sale', description: 'Venda confirmada: Ricardo Tavares — Plano Básico Mensal (R$ 497)', created_at: '2026-03-30T14:00:00Z' },
]

export const mockSupportTickets: SupportTicket[] = [
  { id: 'ticket-001', company_id: 'emp-001', subject: 'Como configurar o tom de voz do agente?', status: 'resolved', created_at: '2026-03-25T09:00:00Z', updated_at: '2026-03-25T09:12:00Z' },
  { id: 'ticket-002', company_id: 'emp-001', subject: 'Campanha pausada automaticamente', status: 'resolved', created_at: '2026-03-28T14:30:00Z', updated_at: '2026-03-28T14:45:00Z' },
  { id: 'ticket-003', company_id: 'emp-001', subject: 'Erro ao gerar relatório PDF', status: 'open', created_at: '2026-03-31T08:00:00Z', updated_at: '2026-03-31T08:10:00Z' },
]
...
export const mockEmpresas = mockCompanies
