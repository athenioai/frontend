            ...
            >
              <label className="inline-flex items-center gap-2.5 cursor-pointer group">
                <span className="relative flex h-[18px] w-[18px] items-center justify-center">
                  ...
                  />
                  <span className="absolute inset-0 rounded-md border border-border-default bg-white transition-all peer-checked:border-accent/50 peer-checked:bg-accent/15 peer-focus-visible:ring-2 peer-focus-visible:ring-accent/20" />
                  <svg
